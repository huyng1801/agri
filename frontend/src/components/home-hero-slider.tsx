        ...
        <div className="lg:hidden">
          {slides.map((slide, index) => {
            ...
            return (
              ...
              >
                {/* 1. Hero Media (Height 220-250px, preserves farmer, QR, phone) */}
                ...
                {/* 2. Carousel Progress Bars (placed under media on mobile) */}
                <div
                ...
                {/* 4. Headline Hierarchy (Balanced, no orphans) */}
