...
export const PASSPORT_NEWS_PLAN: readonly PassportNewsPlanItem[] = [
  { category: 'Chuyển đổi số', categorySlug: 'chuyen-doi-so', title: 'Nhật ký sản xuất điện tử là gì? Lợi ích cho nông hộ và hợp tác xã', slug: 'nhat-ky-san-xuat-dien-tu' },
  { category: 'Chuyển đổi số', categorySlug: 'chuyen-doi-so', title: 'Số hóa vùng trồng: Vì sao dữ liệu từng khu vực sản xuất ngày càng quan trọng?', slug: 'so-hoa-vung-trong-du-lieu-khu-vuc-san-xuat' },
  { category: 'Chuyển đổi số', categorySlug: 'chuyen-doi-so', title: 'Quản lý mùa vụ bằng dữ liệu: Giải pháp giúp hợp tác xã giảm sai sót trong sản xuất', slug: 'quan-ly-mua-vu-bang-du-lieu' },
  { category: 'Chuyển đổi số', categorySlug: 'chuyen-doi-so', title: 'Từ nhật ký canh tác đến hồ sơ sản phẩm: Cách chuẩn hóa dữ liệu nông nghiệp', slug: 'tu-nhat-ky-canh-tac-den-ho-so-san-pham' },
  { category: 'Chuyển đổi số', categorySlug: 'chuyen-doi-so', title: '5 bước xây dựng quy trình quản lý sản xuất nông nghiệp bằng dữ liệu số', slug: '5-buoc-xay-dung-quy-trinh-quan-ly-san-xuat-nong-nghiep' },
  ...
  { category: 'Hợp tác xã', categorySlug: 'tin-htx', title: 'Hồ sơ hợp tác xã cần có những thông tin gì để tăng độ tin cậy với đối tác?', slug: 'ho-so-hop-tac-xa-can-co-thong-tin-gi' },
  { category: 'Hợp tác xã', categorySlug: 'tin-htx', title: 'Hợp tác xã có nhiều sản phẩm nên quản lý thông tin sản phẩm như thế nào?', slug: 'hop-tac-xa-nhieu-san-pham-quan-ly-thong-tin-the-nao' },
  { category: 'Hợp tác xã', categorySlug: 'tin-htx', title: 'Cách giới thiệu hợp tác xã và vùng sản xuất chuyên nghiệp trên nền tảng số', slug: 'gioi-thieu-hop-tac-xa-vung-san-xuat-tren-nen-tang-so' },
  { category: 'Hợp tác xã', categorySlug: 'tin-htx', title: '5 dữ liệu hợp tác xã nên chuẩn hóa trước khi kết nối với nhà phân phối', slug: '5-du-lieu-hop-tac-xa-nen-chuan-hoa' },
  { category: 'Hợp tác xã', categorySlug: 'tin-htx', title: 'Hợp tác xã muốn tìm đầu ra cho nông sản nên chuẩn bị hồ sơ số như thế nào?', slug: 'hop-tac-xa-tim-dau-ra-chuan-bi-ho-so-so' },
  { category: 'Kiến thức', categorySlug: 'kien-thuc-nong-nghiep', title: 'Hồ sơ số sản phẩm nông sản là gì? Vì sao mỗi sản phẩm nên có một hồ sơ riêng?', slug: 'ho-so-so-san-pham-nong-san-la-gi' },
  { category: 'Kiến thức', categorySlug: 'kien-thuc-nong-nghiep', title: 'Một hồ sơ sản phẩm nông nghiệp chuyên nghiệp cần những nội dung nào?', slug: 'ho-so-san-pham-nong-nghiep-chuyen-nghiep-can-noi-dung-gi' },
  { category: 'Kiến thức', categorySlug: 'kien-thuc-nong-nghiep', title: 'Cách xây dựng câu chuyện sản phẩm để tăng niềm tin với người tiêu dùng', slug: 'xay-dung-cau-chuyen-san-pham-nong-nghiep' },
  { category: 'Kiến thức', categorySlug: 'kien-thuc-nong-nghiep', title: 'Từ hình ảnh đến thông tin sản xuất: 8 yếu tố giúp hồ sơ nông sản chuyên nghiệp hơn', slug: '8-yeu-to-giup-ho-so-nong-san-chuyen-nghiep' },
  { category: 'Kiến thức', categorySlug: 'kien-thuc-nong-nghiep', title: 'Số hóa danh mục sản phẩm giúp hợp tác xã quản lý và giới thiệu nông sản như thế nào?', slug: 'so-hoa-danh-muc-san-pham-hop-tac-xa' },
