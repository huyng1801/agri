  ...
  return (
    <PublicShell>
      <main id="main-content">
        ...
        <PublicSection band>
          <PublicSectionHeader title="Tin tức mới nhất" description="Tin HTX, thị trường và truy xuất nguồn gốc từ đội vận hành HTXONLINE." href="/tin-tuc" linkLabel="Xem tin tức" />
          {news.data.length ? (
