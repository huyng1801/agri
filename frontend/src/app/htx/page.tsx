          ...
          <article className="relative overflow-hidden rounded-[2.2rem] bg-[linear-gradient(135deg,#102437_0%,#16354a_52%,#1f8a54_100%)] p-5 text-white shadow-[0_26px_60px_rgba(15,23,42,0.18)] sm:p-6">
            ...
            <div className="relative z-10">
              ...
              <div className="mt-4 grid gap-5 lg:grid-cols-[1.02fr_0.98fr] lg:items-end">
                <div>
                  <h2 className="max-w-[14ch] text-[1.95rem] font-extrabold leading-[0.98] tracking-[-0.04em] text-white sm:text-[2.8rem]">
                    {featuredCooperative?.name ?? 'Các HTX đã sẵn sàng đưa sản phẩm ra thị trường.'}
                  </h2>
