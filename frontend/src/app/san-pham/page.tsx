...
function ProductFilterForm({ filters, hasActiveFilter }: { filters: ProductFilters; hasActiveFilter: boolean }) {
  return (
    <form className="mt-4 rounded-[1.7rem] border border-[#e8e4d8] bg-white p-3 shadow-[0_18px_42px_rgba(15,23,42,0.06)] sm:mt-5 sm:rounded-[2rem] sm:p-4" action="/san-pham">
      <div className="relative">
        ...
        <input
          ...
          className="min-h-11 w-full rounded-[1.1rem] border border-[#e8e4d8] bg-[#f7faf4] pl-10 pr-3 text-base outline-none focus:border-leaf focus:ring-4 focus:ring-mint sm:min-h-12"
        />
      </div>

      <details className="mt-2.5 rounded-[1.2rem] border border-[#e8e4d8] bg-[#f7faf4] p-2.5 lg:hidden" open={Boolean(filters.province || filters.minPrice || filters.maxPrice)}>
      ...
      <div className="mt-2.5 grid gap-2 sm:flex sm:flex-wrap sm:items-center sm:gap-3">
        <label className="inline-flex min-h-11 items-center gap-2 rounded-[1rem] border border-[#e8e4d8] bg-[#f7faf4] px-3 text-sm font-semibold text-slate-700">
        ...
        <label className="inline-flex min-h-11 items-center justify-between gap-2 rounded-[1rem] border border-[#e8e4d8] bg-[#f7faf4] px-3 text-sm font-semibold text-slate-700">
